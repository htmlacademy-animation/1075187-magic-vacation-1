...
/***/ "./source/js/modules/count-numbers.js":
/*!********************************************!*\
  !*** ./source/js/modules/count-numbers.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CountNumbers; });
class CountNumbers {
...
/* harmony import */ var _countdown_timer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./countdown-timer */ "./source/js/modules/countdown-timer.js");



const timer = new _countdown_timer__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _count_numbers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./count-numbers */ "./source/js/modules/count-numbers.js");
      ...
      images.forEach(({path, timeDelay, target, startNumber, maxNumber}, i) => {
        setTimeout(() => {
          ...
          prizesDesc[i].addEventListener(`animationstart`, () => {
            if (maxNumber) {
              const countNumbers = new _count_numbers__WEBPACK_IMPORTED_MODULE_0__["default"](prizesDesc[i].querySelector(`b`), startNumber, maxNumber);
...
const animationTopTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_9__["default"](`#top .intro__title`, 500, `active-text`, `transform`);
const animationTopDate = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_9__["default"](`#top .intro__date`, 500, `active-text`, `transform`);
